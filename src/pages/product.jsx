    ...
    return (
        <>
            <div className='container-center'>
                <section className='grid  grid-cols-5 mx-auto max-w-screen-xl gap-x-7 my-20'>
                    <div className='col-span-3 flex flex-col justify-evenly'>
                        <h5 className='text-4xl font-bold '>Grow your Sales and Services</h5>
                ...
                <section className='flex my-20 justify-between gap-10 w-full  max-w-7xl mx-auto flex-wrap'>{[12, 3, 45, 34].map((e) => (<img key={e} src={testLogo} alt='text-image' />))}</section>

                <section className='flex flex-col pt-16 bg-gradient-to-l from-[#def7ed] to-[#eaeffb] w-100 mx-[-4rem]'>
                    ...
                    <div className='bg-[#ffffff81] grid grid-cols-3 gap-10 mr-52 rounded-tr-3xl p-20'>
                ...
                <section className=' grid grid-cols-2 mx-[4rem] bg-white px-15 py-10 gap-8'>
                    <div className='flex m-auto flex-col gap-y-5'>
                    ...
                    <div>
                        <img src={second} alt='img tag'></img>
                    </div>
                </section>
            </div>
        </>
